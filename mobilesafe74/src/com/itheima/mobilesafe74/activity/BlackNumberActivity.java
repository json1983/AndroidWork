...
//				OnScrollListener.SCROLL_STATE_TOUCH_SCROLL	拿手触摸着去滚动状态
				if (mBlackNumberList!=null) {
					...
					if (scrollState==OnScrollListener.SCROLL_STATE_IDLE && lv_blacknumber
							.getLastVisiblePosition()>=mBlackNumberList.size()-1 && !mIsLoad) {
						/*mIsLoad防止重复加载的变量
	...
	protected void showDialog() {
		...
		//为了使得高版本与低版本android系统兼容:左,上,右,下,间距设置为0
